...
func toOpenAIOptions(opts []Option) []openai.Option {
	...
	return o.ToOpenAIOptions(DefaultBaseURL, "MISTRAL_API_KEY")
}

// WithAPIKey sets the Mistral API key. Defaults to the MISTRAL_API_KEY environment variable.
...
// WithBaseURL sets the base URL for Mistral API endpoints (default: https://api.mistral.ai/v1).
