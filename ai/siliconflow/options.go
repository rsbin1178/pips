...
// Option configures a SiliconFlow model.
...
func toOpenAIOptions(opts []Option) []openai.Option {
	...
	return o.ToOpenAIOptions(DefaultBaseURL, "SILICONFLOW_API_KEY")
}
...
func toCohereOptions(opts []Option) []cohere.Option {
	...
	return o.ToCohereOptions(DefaultBaseURL, "SILICONFLOW_API_KEY")
}

// WithAPIKey sets the SiliconFlow API key. Defaults to the SILICONFLOW_API_KEY environment variable.
...
// WithBaseURL sets the base URL for SiliconFlow API endpoints (default: https://api.siliconflow.cn/v1).
