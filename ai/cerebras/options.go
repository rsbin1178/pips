...
func toOpenAIOptions(opts []Option) []openai.Option {
	...
	return o.ToOpenAIOptions(DefaultBaseURL, "CEREBRAS_API_KEY")
}

// WithAPIKey sets the Cerebras API key. Defaults to the CEREBRAS_API_KEY environment variable.
...
// WithBaseURL sets the base URL for Cerebras API endpoints (default: https://api.cerebras.ai/v1).
