...
// Option configures a Zhipu model.
...
func toOpenAIOptions(opts []Option) []openai.Option {
	...
	return o.ToOpenAIOptions(DefaultBaseURL, "ZHIPU_API_KEY")
}
...
func toCohereOptions(opts []Option) []cohere.Option {
	...
	return o.ToCohereOptions(DefaultBaseURL, "ZHIPU_API_KEY")
}

// WithAPIKey sets the Zhipu API key. Defaults to the ZHIPU_API_KEY environment variable.
...
// WithBaseURL sets the base URL for Zhipu AI endpoints (default: https://open.bigmodel.cn/api/paas/v4).
